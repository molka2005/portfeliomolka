        ...
        <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          ...
          >
            <div className="relative w-48 h-48 lg:w-80 lg:h-80">
              ...
              <div
                className="absolute -inset-4 lg:-inset-12 bg-linear-to-l from-[#f97316] via-[#fb923c] to-[#f59e0b] rotate-12 star-shape z-0 transition-transform duration-700 hover:rotate-45"
                data-aos="zoom-in"
                data-aos-delay="600"
              ></div>
              <img 
